...
function C2 = admmLasso_mat_func_S4C(Y,affine,alpha,thr,maxIter,lambda,alphass,W,Md,Nd)
...
if (~affine)
    ...
    while ( (err1(i) > thr1 || err3(i) > thr1) && i < maxIter )
        ...
        %Prximo paquete de lines comentar para mirar con cual evoluvciona
        %mejor 
        % update \bar{C}
...
%         
        %Proxima linea descomentar para ver exactitud de un metodod
%         C_average = C2;
        % updating Lagrange multipliers
