function [Xmember,Ymember,log]=SRSSSC(F,hyperimg_gt,bordes,Nb)
...
l = length(unique(s1))-1;% Number of clusters that have the data

if l == 0
    l = TSC(F1,a); % Function to estimate the clusters presents in the data
end
